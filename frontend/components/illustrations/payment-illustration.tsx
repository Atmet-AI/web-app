export const PaymentIllustration = () => (
    <div
        ...
        <div className="bg-linear-to-b blur-xs pointer-events-none absolute inset-y-6 start-0 w-2 rounded-2xl from-indigo-500 via-white to-purple-500 opacity-35"></div>
        ...
        <div className="inset-shadow-sm inset-shadow-white/3 ring-foreground/10 bg-card/95 relative space-y-5 rounded-2xl p-8 ring-1 backdrop-blur">
            <div>
                <div className="text-foreground mb-3 text-sm font-medium">Workspace</div>
                <div className="bg-background ring-foreground/10 col-span-2 flex h-8 items-center justify-between rounded-md border border-transparent px-2 shadow ring-1">
                    <span className="text-muted-foreground text-sm">ops@atmetai.com</span>
                </div>
            </div>
            <div className="text-foreground mb-3 text-sm font-medium">Approval details</div>
            <div className="relative grid grid-cols-2 -space-y-px [--input-radius:var(--radius-lg)]">
                <div className="bg-background ring-foreground/10 col-span-2 flex h-8 items-center justify-between rounded-t-md border border-transparent px-2 shadow ring-1">
                    <span className="text-muted-foreground text-sm">Send weekly summary</span>
                    <svg
                        aria-hidden="true"
                        className="h-2.5"
                ...
                <div className="ring-foreground/10 bg-background flex h-8 items-center rounded-es-md border border-transparent px-2 shadow ring-1">
                    <span className="text-muted-foreground text-sm">Review</span>
                </div>
                <div className="ring-foreground/10 bg-background flex h-8 items-center rounded-ee-md border border-transparent px-2 shadow ring-1">
                    <span className="text-muted-foreground text-sm">Approve</span>
                </div>
            </div>
        </div>
    </div>
