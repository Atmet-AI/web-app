...
const MainIllustration = () => (
    <div
        ...
        <div className="inset-shadow-sm inset-shadow-white/3 ring-foreground/10 bg-background/75 relative space-y-5 rounded-2xl p-2 ring-1 backdrop-blur-xl">
            <div>
                <div className="text-muted-foreground px-2 pb-2 text-sm">ops@atmetai.com</div>
                ...
                <div className="bg-foreground/5 ring-foreground/10 flex flex-col gap-2 rounded-md border border-transparent p-4 shadow ring-1">
                    <div className="text-foreground mb-1 text-sm font-medium">Approve workflow</div>
                    <div className="text-muted-foreground text-sm">Atmet prepared the next step. Review the action details, confirm the code, and let the agent continue.</div>
                    ...
                    <div className="mx-auto mb-3 mt-5 grid w-56 grid-cols-2 gap-4">
                        <div className="*:hover:ring-foreground/15 grid grid-cols-3 gap-1.5">
                            <div className="border-border-illustration bg-background/75 hover:ring-emerald-500! relative flex h-8 items-center justify-center rounded border font-mono text-sm shadow-xl shadow-black/65 ring-1 ring-emerald-500">
                ...
                <div className="text-muted-foreground px-2 pt-2 text-xs">Powered by Atmet</div>
            </div>
        </div>
    </div>
)
