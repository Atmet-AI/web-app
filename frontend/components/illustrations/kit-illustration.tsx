        ...
        <div
            ...
            <div className="relative mx-auto mt-auto [--color-primary:var(--color-emerald-500)] sm:px-8">
                <div className="absolute inset-x-8 bottom-12 z-10 mx-auto sm:w-3/5">
                    <div className="bg-linear-to-b blur-xs pointer-events-none absolute inset-y-6 start-0 w-2 rounded-2xl from-transparent via-white to-purple-500 opacity-75"></div>
                    <div className="ring-foreground/10 bg-illustration/75 inset-shadow-sm inset-shadow-white/4 rounded-2xl border border-transparent p-6 text-xs shadow-2xl shadow-black ring-1 backdrop-blur">
                        <div className="mb-0.5 text-sm font-semibold">Workflow</div>
                        ...
                        <p>
                            <span className="text-muted-foreground/65">Connected to 12</span> <span className="text-primary font-medium">business workflows</span>.
                        </p>
                    </div>
                </div>
                <div className="bg-card blur-xs ms-auto h-80 w-4/5 rounded-2xl px-6 py-4 opacity-50">
                    <div className="space-y-2">
                        <div>Favorite skills</div>
                        <div className="*:hover:bg-muted -mx-2 flex flex-col gap-0.5 *:cursor-pointer *:rounded-md *:p-2">
                            <div className="flex items-center gap-1">
                                <QuartzKitLogo />
                                <div className="text-xs">Inbox triage</div>
                                <div className="text-muted-foreground ms-auto text-xs">Now</div>
                            </div>
                            <div className="flex items-center gap-1">
                                <DuskKitLogo />
                                <div className="text-xs">CRM update</div>
                                <div className="text-muted-foreground ms-auto text-xs">12h ago</div>
                            </div>
                            <div className="flex items-center gap-1">
                                <MistKitLogo />
                                <div className="text-xs">Report draft</div>
                                <div className="text-muted-foreground ms-auto text-xs">2 days ago</div>
                            </div>
                            <div className="flex items-center gap-1">
                                <QuartzKitLogo />
                                <div className="text-xs">Inbox triage</div>
