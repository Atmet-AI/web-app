...
export const CompletePaymentIllustration = () => (
    <div className="mask-b-from-35% relative -mx-8 sm:px-8">
...
const MainIllustration = () => (
    <div
        ...
        <div className="inset-shadow-sm inset-shadow-white/3 ring-foreground/10 bg-illustration/75 relative space-y-5 rounded-2xl p-6 ring-1 backdrop-blur">
            <div>
            ...
            <div className="relative grid grid-cols-2 space-y-px [--input-radius:var(--radius-lg)]">
                ...
                <div className="ring-foreground/10 bg-foreground/2 flex h-8 items-center rounded-es-md border border-transparent px-2 shadow ring-1">
                    <span className="text-muted-foreground text-sm">MM/YY</span>
                </div>
                <div className="ring-foreground/10 bg-foreground/2 ms-px flex h-8 items-center rounded-ee-md border border-transparent px-2 shadow ring-1">
