...
export const InvoiceSigningIllustration = ({ className }: { className?: string }) => {
    return (
        <div
            ...
            <div className="bg-linear-to-b blur-xs pointer-events-none absolute inset-y-6 start-0 w-2 rounded-2xl from-indigo-500 via-white to-purple-500 opacity-15"></div>
