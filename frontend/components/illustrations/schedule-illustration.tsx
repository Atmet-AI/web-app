...
export const ScheduleIllustation = ({ className, variant = 'mixed' }: IllustrationProps) => {
    return (
        <div className="mt-auto max-w-sm">
            <div className={cn('relative h-fit ps-8 pt-12', className)}>
                <div className="bg-linear-to-r blur-xs pointer-events-none absolute start-12 top-0 h-2 w-1/2 rounded-2xl from-transparent via-purple-400 to-sky-500 opacity-75"></div>
                <div
                    className={cn('bg-illustration/85 absolute flex -translate-x-8 rtl:translate-x-8 -translate-y-[110%] items-center gap-2 rounded-xl p-1', {
