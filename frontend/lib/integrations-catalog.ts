...
export const INTEGRATIONS_CATALOG: CatalogIntegration[] = [
  {
    ...
    scopes: [
      { name: "gmail.modify", description: "Read, label, and update message metadata when workflows run." },
      { name: "gmail.send", description: "Send outbound emails from workflow actions you approve." },
