...
export const INTEGRATIONS_CATALOG: CatalogIntegration[] = [
  ...
  },
  {
    ...
    setupInstructions: [
      ...
      "Composio will open the OpenAI connection flow.",
      "Authorize the OpenAI account or API access Composio asks for.",
      "Return to Atmet and use OpenAI actions inside chats or workflows.",
    ],
    scopes: [
