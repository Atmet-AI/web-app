...
const dialCodes: Record<string, string> = {
  ...
  HK: "+852", HM: "+672", HN: "+504", HR: "+385", HT: "+509", HU: "+36", ID: "+62", IE: "+353", IL: "+972", IM: "+44", IN: "+91", IO: "+246", IQ: "+964", IR: "+98", IS: "+354", IT: "+39", JE: "+44", JM: "+1", JO: "+962", JP: "+81",
  KE: "+254", KG: "+996", KH: "+855", KI: "+686", KM: "+269", KN: "+1", KP: "+850", KR: "+82", KW: "+965", KY: "+1", KZ: "+7", LA: "+856", LB: "+961", LC: "+1", LI: "+423", LK: "+94", LR: "+231", LS: "+266", LT: "+370", LU: "+352", LV: "+371", LY: "+218",
...
export const phoneCountries = countries.map((country) => ({
  ...country,
  dialCode: dialCodes[country.value] ?? "",
}))

export function getPhoneCountry(value: string | null | undefined) {
  return phoneCountries.find((country) => country.value === value)
}

export function buildInternationalPhone(countryCode: string | null | undefined, phoneNumber: string | null | undefined) {
  const number = phoneNumber?.trim()
  if (!number) return ""

  const country = getPhoneCountry(countryCode)
  return [country?.dialCode, number].filter(Boolean).join(" ")
}

export function buildWhatsappUrl(countryCode: string | null | undefined, phoneNumber: string | null | undefined) {
  const value = buildInternationalPhone(countryCode, phoneNumber).replace(/[^\d]/g, "")
