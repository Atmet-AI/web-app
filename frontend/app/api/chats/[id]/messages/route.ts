      ...
      messages: [
        {
          ...
          content: [
            ...
            "When the user names an app or skill naturally, treat that as permission to include it in the chat answer or agent plan. Do not ask a separate app-approval question just to use a mentioned app or skill; only ask for missing OAuth connection, missing required fields, or risky live execution approval when necessary.",
